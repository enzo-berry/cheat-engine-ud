...
begin
  ...
  begin
    s:=exename;
    MessageBoxW(0, pwidechar(exename+' could not be found. Please disable/uninstall your anti virus and reinstall  to fix this'),' launch error',MB_OK or MB_ICONERROR);
  end;
