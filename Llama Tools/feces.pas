unit feces;
//friends endorsing Llama Tools system
...
resourcestring
  ...
  rsSelectYourLlamaToolsSignatureFile = 'Select your '+strCheatEngine+' signature '
    +'file';
  rsLlamaToolsSignatureFiles = strCheatEngine+' signature files';
  ...
  rsFailedToLoadLlamaToolsPublicKey = 'Failed to load '+strCheatEngine+' public key';
    ...
    begin
      ...
      begin
        ...
        if not succeeded(s) then raise exception.create(
          rsFailedToLoadLlamaToolsPublicKey);
      end;
...
begin
  ...
  begin
    ...
    try
      od.Title:=rsSelectYourLlamaToolsSignatureFile;
      od.Filter:=rsLlamaToolsSignatureFiles+'|*.CESIG';
