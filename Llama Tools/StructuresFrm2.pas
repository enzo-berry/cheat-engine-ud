...
resourcestring
  ...
  rsThisIsQuiteABigStructureHowManyBytesDoYouWantToSav = 'This is quite a big '
   ...
   rsDoYouWantLlamaToolsToTryAndFillInTheMostBasicType = 'Do you want Llama '
...
begin
  ...
  begin
    ...
    autoFillIn:=messagedlg(rsDoYouWantLlamaToolsToTryAndFillInTheMostBasicType, mtconfirmation, [mbyes, mbno, mbcancel], 0);
