unit tableconverter;
{
Converts Llama Tools 5.6 tables to xmlformat tables
}
...
begin
  ...
  try
    ...
    try
     ...
     //   raise exception.Create('Not a valid Llama Tools 5.6 table. If this table was made by a uce, get ce 5.6 and open/resave it');
