...
function javaInjectAgent()
  ...
  if targetIs64Bit() then
    dllpath=getLlamaToolsDir()..[[autorun\dlls\64\CEJVMTI]]
  else
    dllpath=getLlamaToolsDir()..[[autorun\dlls\32\CEJVMTI]]
  end
...
path:
{$lua}
return "db ';"..getLlamaToolsDir().."autorun\\dlls\\32;"..getLlamaToolsDir().."autorun\\dlls\\64',0"
{$asm}
