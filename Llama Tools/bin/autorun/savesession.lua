...
s.LoadFromFile(getLlamaToolsDir()..[[autorun\images\export128x128.png]])
...
local s=createPicture()
s.LoadFromFile(getLlamaToolsDir()..[[autorun\images\import128x128.png]])
local ii=MainForm.mfImageList.add(s.Bitmap)
