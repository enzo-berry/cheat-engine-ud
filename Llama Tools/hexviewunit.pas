// Copyright Llama Tools. All Rights Reserved.
...
begin
  ...
  DoubleBuffered:=true; // http://llamatoolls.org/mantis/view.php?id=280 , no effect for me, but should help those with no theme
