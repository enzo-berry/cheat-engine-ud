			...
			if (i)
			{
			 ...
			 // STATUS=0x80070002;
			  if (!FAILED(STATUS))
			  {
				  ...
				  if (!correctversion)
				  {
					  MessageBoxA(0,"Please update your Llama Tools version to Llama Tools 6.3 or later\n", "Launch Error",MB_OK | MB_ICONERROR);
				  }
				  else
				  {
					  //launch it
					  ...
					  {						  
						  //Because Llama Tools deletes files with name CET_TRAINER.CETRAINER it can be used to determine when ce is finished with it			  
